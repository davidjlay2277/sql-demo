...
//first run: npm i sequelize pg -pg-hstore
// process.env.CONNECTION_STRING
// or.....you can destructure values from your env
const {CONNECTION_STRING} = process.env

//importing a class
const Sequelize = require('sequelize');

//create a new instance of the above class with our connection string
const sequelize = new Sequelize(CONNECTION_STRING, {
    dialect: 'postgress' ,
    dialectOptions: {
        // allow to send http requests and not just https, fine for class
        ssl: {
...
module.exports = {
    seed: (req, res) => {
        ...
        `).then(() => {
            ...
            //sendStatus just sending a code. otherwise use .send
            res.sendStatus(200)
